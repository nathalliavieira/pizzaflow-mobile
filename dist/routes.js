...
//Rota para buscar as informacoes do usuário
router.get("/me", isAuthenticated_1.isAuthenticated, new DetailUserController_1.DetailUserController().handle); //lembrando que isAuthenticated é o middleware de autenticacao
//-----------ROTAS CATEGORIAS---------
...
//-----------ROTAS PRODUCTS---------
// router.post("/product", isAuthenticated, upload.single("file"), new CreateProductController().handle); Essa rota seria se nao estivessemos usando o express upload
